...
<body>
    ...
    <div id="navMenu" class="navbar-menu">
      ...
      <img src="VeganEats logo.png" alt="VeganEats" id="hero-image">
	   	...
	   	<h1>Check Out Our Featured Gluten Free Dishes</h1>
...
<br>
<br>
<h1 style="font-size: 1.33em">Google Searches for "gluten free" Have Gained Massive Interest.</h1>
...
$.ajax({
    ...
    url: "recipePHP/fetch_Glutenfree.php",
    method: "GET",
    dataType: 'json',
    success: function(data) {
